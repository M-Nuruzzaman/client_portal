...
class DynamicImagePickerSlider extends StatefulWidget {
  final List<String> headings;
  final List<File?> photos;
  final Function(List<File?>) onImagesSelected;

  const DynamicImagePickerSlider({
    super.key,
  ...
  @override
  _DynamicImagePickerSliderState createState() =>
      _DynamicImagePickerSliderState();
}

class _DynamicImagePickerSliderState extends State<DynamicImagePickerSlider> {
